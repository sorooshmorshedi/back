...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('factors', '0017_factor_temporary_code'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='adjustment',
            options={'default_permissions': (), 'ordering': ['-pk'], 'permissions': (('get.adjustment', 'مشاهده تعدیل '), ('create.adjustment', 'تعریف تعدیل '), ('update.adjustment', 'ویرایش تعدیل '), ('delete.adjustment', 'حذف تعدیل '), ('getOwn.adjustment', 'مشاهده تعدیل های خود'), ('updateOwn.adjustment', 'ویرایش تعدیل های خود'), ('deleteOwn.adjustment', 'حذف تعدیل های خود'))},
        ),
        migrations.AlterModelOptions(
            name='expense',
