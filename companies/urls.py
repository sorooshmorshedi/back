...
from companies.views.company_users_views import CompanyUserInvitationModelView
...
router.register('companyUserInvitations', CompanyUserInvitationModelView, basename='company-user')
