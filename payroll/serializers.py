...
class WorkshopPersonnelSerializer(serializers.ModelSerializer):
    ...
    total_insurance_month = serializers.DecimalField(source='insurance_history_total', read_only=True, max_digits=24, decimal_places=2)
    current_insurance_month = serializers.DecimalField(source='current_insurance', read_only=True, max_digits=24, decimal_places=2)
